...
var Flexible = function (designWidth, designHeight, scalePolicy) {
	designWidth  = designWidth || 1334;
	designHeight = designHeight || 750;
	...
	function getCssText(w, h, r, x, y) {
		...
		// return 'transform-origin:50% 50%;transform:translate(' + x + 'px,' + y + 'px) rotate(' + r + 'deg);-webkit-transform:translate(' + x + 'px,' + y + 'px) rotate(' + r + 'deg);width:' + w + 'px;height:' + h + 'px;';
	}
